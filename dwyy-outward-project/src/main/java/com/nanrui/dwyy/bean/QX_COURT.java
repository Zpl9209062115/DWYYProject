 ...
 * 抢修台区相关实体类
 */
@Entity(name = "QX_COURT")
@Table(name = "QX_COURT")
@GenericGenerator(name = "jpa-uuid", strategy = "uuid")
public class QX_COURT implements Serializable {
    ...
    public QX_COURT(Integer COURTCOUNT, Date DATEUPDATE, Integer JAN_COURT_COUNT, Integer FEB_COURT_COUNT, Integer MAR_COURT_COUNT, Integer APR_COURT_COUNT, Integer MAY_COURT_COUNT, Integer JUN_COURT_COUNT, Integer JUL_COURT_COUNT, Integer AUG_COURT_COUNT, Integer SEPT_COURT_COUNT, Integer OCT_COURT_COUNT, Integer NOV_COURT_COUNT, Integer DEC_COURT_COUNT, String CITY) {
